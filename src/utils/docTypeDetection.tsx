...
export function getDocTypeIcon(type: LinkedItemType): { icon: JSX.Element; color: string } {
  switch (type) {
    ...
    case 'amplitude':
      return {
        icon: (
          <svg className="w-4 h-4" viewBox="0 0 241 241" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path fillRule="evenodd" clipRule="evenodd" d="M0.414307 120.632C0.414307 54.3652 54.186 0.631836 120.5 0.631836C186.814 0.631836 240.586 54.3652 240.586 120.632C240.586 186.899 186.814 240.632 120.5 240.632C54.186 240.632 0.414307 186.899 0.414307 120.632ZM206.828 122.799C207.985 121.843 208.807 120.532 209.141 119.187C209.864 115.765 207.595 112.387 204.16 111.71H204.115L204.015 111.665H203.915C203.57 111.61 203.281 111.565 202.948 111.565L202.08 111.465C181.977 110.021 161.24 109.443 141.849 109.054L141.804 108.91C132.353 73.4874 120.533 37.2985 104.622 37.2985C89.767 37.3429 76.413 61.1541 64.8825 107.999C59.5973 107.941 54.6311 107.861 49.8947 107.784C47.2873 107.742 44.7495 107.701 42.2664 107.665H41.2101C40.3428 107.621 39.4755 107.665 38.6082 107.765C35.1391 108.399 32.4372 111.187 31.9034 114.71C31.2252 119.243 34.3607 123.476 38.8973 124.154L38.9974 124.254H61.1799C59.1562 133.598 57.3216 142.91 55.8316 151.821L55.1534 155.776V155.965C55.1534 157.843 56.1207 159.576 57.7107 160.587C60.2681 162.221 63.6928 161.454 65.3273 158.899L65.4718 159.043L76.324 124.299H128.595C132.598 139.421 136.745 154.987 142.238 169.643L142.252 169.682C145.207 177.559 152.053 195.81 163.508 195.91H163.653C181.399 195.91 188.348 167.232 192.929 148.243C193.16 147.317 193.381 146.421 193.593 145.558C194.319 142.6 194.95 140.034 195.587 138.021L195.92 136.965C195.976 136.732 196.021 136.487 196.021 136.199C196.021 135.087 195.298 134.076 194.286 133.687C192.885 133.11 191.295 133.832 190.717 135.232L190.328 136.287C190.074 137.001 189.822 137.708 189.574 138.408C188.364 141.81 187.222 145.023 186.18 147.898L186.08 148.143C178.363 169.887 174.839 179.81 167.989 179.81H167.8H167.7H167.511C158.78 179.81 150.604 144.745 147.401 131.008L147.308 130.61C146.992 129.206 146.672 127.858 146.372 126.597C146.177 125.773 145.989 124.985 145.818 124.243H202.725C203.782 124.243 204.805 123.999 205.716 123.521L205.961 123.376L206.25 123.187L206.395 123.087C206.467 123.037 206.539 122.99 206.611 122.943C206.684 122.896 206.756 122.849 206.828 122.799ZM104.877 53.2412C105.744 53.2412 106.467 53.719 107.145 54.5856C108.791 57.1412 111.682 62.9745 115.985 75.9301C118.92 84.8412 122.1 95.8301 125.48 108.652C113.905 108.481 102.183 108.347 90.7616 108.216C89.5664 108.202 88.3744 108.188 87.1863 108.175L80.8151 108.13C87.998 80.0856 96.7264 58.8301 103.142 53.819C103.676 53.4856 104.254 53.2856 104.877 53.2412Z" fill="#005EFF"/>
          </svg>
        ),
        color: '#005EFF'
      };
